...
import { ArrowLeft, Share2, Star, Clock, Users, PlayCircle, CheckCircle, Lock, Check, GraduationCap, Edit2, Sparkles } from "lucide-react";
            ...
            <div className="flex items-start gap-6">
              ...
              >
                <img 
                  ...
                  className="w-20 h-20 rounded-full bg-indigo-50 border border-indigo-100 shadow-md transform -rotate-6 transition-transform"
                />
